...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference("Following.count") do
      post followings_url, params: { following: { followed: @following.followed, follower: @following.follower } }
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { followed: @following.followed, follower: @following.follower } }
